...
namespace Marketplace.Infra.Migrations
{
    ...
    [Migration("20220628131739_add_youtube_link_provider")]
    partial class add_youtube_link_provider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("authorization_sale")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.AppointmentLog", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("jsonRq")
                        .HasColumnType("jsonb");

                    b.Property<string>("jsonRs")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.Faq", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.FaqQuestion", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.AppointmentLog", b =>
                {
                    b.HasOne("Marketplace.Domain.Entities.Appointment", "Appointment")
                        .WithMany("Logs")
            ...
            modelBuilder.Entity("Marketplace.Domain.Entities.FaqQuestion", b =>
                {
                    b.HasOne("Marketplace.Domain.Entities.Faq", "Faq")
                        .WithMany("Question")
